...
// Auto select days based on the select option
...
document.getElementById("ineligibilityForm").addEventListener("submit", function (e) {
    e.preventDefault();
    let reason = document.getElementById("reason").value;
    let days = document.getElementById("days").value;
    let donorId = document.getElementById("donor_id").value;

    if ((reason === "other" || reason.includes("Dental Work")) && !days) {
        alert("Please enter the number of days for 'Other' or 'Dental Work'.");
        return;
    }
    ...
    fetch('profile.php', {
        ...
        body: `reason=${encodeURIComponent(reason)}&days=${encodeURIComponent(days)}`
    })
...
document.getElementById("cancel-btn2").addEventListener("click", function () {
    ...
    document.getElementById("days").setAttribute("readonly", true);
    document.getElementById("days").setAttribute("disabled", true);
    document.getElementById("days").setAttribute("type", "text");
});
